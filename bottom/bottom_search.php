<?php
    ...
    $sql = "select * from bottom where $category='$search'";
    ...
    echo "<A HREF='bottom_select.php'><b>하의</b></A>";
    echo "<A HREF='../dress/dress_select.php'>원피스</A>";
    echo "<A HREF='../shoes/shoes_select.php'>신발</A>";
    echo "</div>";

    echo "<br><br> <a href='bottom_insert.php' id='insert'>하의 추가</a> <br><br>";

    echo "<div class='search'>";
    echo "<form action='bottom_search.php' method='get'>";
    ...
    echo "<tr>";
    echo "<th><a href='bottom_select.php?sort=name'>상품명</th> <th><a href='bottom_select.php?sort=color'>색상</th> <th><a href='bottom_select.php?sort=price'>가격</th>";
    echo "<th>총장</th> <th>허리너비</th> <th>엉덩이너비</th> <th>허벅지너비</th> <th>밑단너비</th> <th>밑위</th>";
    echo "<th><a href='bottom_select.php?sort=date'>구매날짜</th> <th><a href='bottom_select.php?sort=preference'>선호도</th> <th>수정</th> <th>삭제</th>";
    echo "</tr>";
    ...
    while($row = mysqli_fetch_array($ret)) {
        ...
        echo "<td>", $row['hip_width'], "</td>";
        echo "<td>", $row['thigh_width'], "</td>";
        echo "<td>", $row['bottom_width'], "</td>";
        echo "<td>", $row['rise'], "</td>";
        echo "<td>", $row['date'], "</td>";
        echo "<td>", $row['preference'], "</td>";
        echo "<TD id='update'>", "<A HREF='bottom_update.php?name=", $row['name'], "'>수정</A></TD>";
        echo "<TD id='delete'>", "<A HREF='bottom_delete.php?name=", $row['name'], "'>삭제</A></TD>";
    }
