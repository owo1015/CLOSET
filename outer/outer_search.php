<?php
    ...
    $sql = "select * from outerwear where $category='$search'";
    ...
    echo "<A HREF='outer_select.php'><b>겉옷</b></A>";
    echo "<A HREF='../bottom/bottom_select.php'>하의</A>";
    echo "<A HREF='../dress/dress_select.php'>원피스</A>";
    echo "<A HREF='../shoes/shoes_select.php'>신발</A>";
    echo "</div>";

    echo "<br><br> <a href='outer_insert.php' id='insert'>겉옷 추가</a> <br><br>";

    echo "<div class='search'>";
    echo "<form action='outer_search.php' method='get'>";
    ...
    echo "<tr>";
    echo "<th><a href='outer_select.php?sort=name'>상품명</th> <th><a href='outer_select.php?sort=color'>색상</th> <th><a href='outer_select.php?sort=price'>가격</th>";
    echo "<th>총장</th> <th>어깨너비</th> <th>가슴너비</th> <th>허리너비</th> <th>밑단너비</th> <th>암홀</th> <th>소매길이</th> <th>소매너비</th>";
    echo "<th><a href='outer_select.php?sort=date'>구매날짜</th> <th><a href='outer_select.php?sort=preference'>선호도</th> <th>수정</th> <th>삭제</th>";
    echo "</tr>";
    ...
    while($row = mysqli_fetch_array($ret)) {
        ...
        echo "<TD id='update'>", "<A HREF='outer_update.php?name=", $row['name'], "'>수정</A></TD>";
        echo "<TD id='delete'>", "<A HREF='outer_delete.php?name=", $row['name'], "'>삭제</A></TD>";
    }
